...
<html lang="en">
	<!-- begin::Head -->
	@include('layouts.partial-base.css')
	<!-- end::Head -->
	...
	<body class="kt-page-content-white kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-aside--enabled kt-aside--fixed kt-page--loading">
		...
		<!-- begin:: Header Mobile -->
        @include('layouts.partial-base.mobile.header')
		<!-- end:: Header Mobile -->
		<div class="kt-grid kt-grid--hor kt-grid--root">
			<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					<!-- begin:: Header -->
                    @include('layouts.partial-base.header')
					<!-- end:: Header -->
						...
						<div class="kt-container  kt-container--fluid  kt-grid kt-grid--ver">
							...
							<!-- begin:: Aside -->
                                ...
                                <div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop" id="kt_aside">
                                    ...
                                    <!-- begin:: Aside Menu -->
                                    @include('layouts.partial-base.aside')
                                    <!-- end:: Aside Menu -->
                                </div>
							<!-- end:: Aside -->
							<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
								...
								<!-- end:: Content -->
					<!-- begin:: Footer -->
                    @include('layouts.partial-base.footer')
					<!-- end:: Footer -->
				</div>
			</div>
		</div>
		...
		<!-- end::Quick Panel -->
        @include('layouts.partial-base.quick-panel')
		<!-- begin::Scrolltop -->
        @include('layouts.partial-base.scroll-top')

		<!-- end::Scrolltop -->

		<!-- begin::Sticky Toolbar -->
        @include('layouts.partial-base.sticky-toolbar')
        ...
        @include('layouts.partial-base.script')
		<!--end::Page Scripts -->
	</body>
